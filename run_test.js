...
const document = {
  getElementById: () => ({ style: {}, classList: { add: ()=>{}, remove: ()=>{} }, appendChild: ()=>{}, innerHTML: '' }),
...
const Audio = class { play() {} };
const Image = class {};
const THREE = {
  Scene: class {}, PerspectiveCamera: class {}, WebGLRenderer: class { setSize(){} setPixelRatio(){} },
  Color: class {}, FogExp2: class {}, AmbientLight: class {}, DirectionalLight: class {},
  Group: class {}, TextureLoader: class { load(){} }, Clock: class {}, Vector3: class {}
};
const CANNON = {
  World: class { addBody(){} }, Body: class { addShape(){} }, Box: class {}, Vec3: class {},
  Material: class {}, ContactMaterial: class {}
};
const JSZip = class {};
