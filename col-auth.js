...
(async function() {
    ...
    function injectAuthStyles() {
        ...
        style.innerHTML = `
            ...
            .col-auth-inp:focus { border-color: var(--signal, #F2B84B); box-shadow: 0 0 0 4px rgba(242,184,75,0.15), inset 0 0 0 1px rgba(242,184,75,0.2); background: var(--void, rgba(255, 255, 255, 0.05)); }
