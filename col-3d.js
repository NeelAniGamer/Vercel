...
(function() {
    ...
    function waitForThree(cb) {
        ...
        var interval = setInterval(function() {
            checks++;
            if (typeof THREE !== 'undefined') { clearInterval(interval); cb(); }
        ...
        var scenes = {
            ...
            home: function() {
                ...
                return function(time) {
                    ringGroups.forEach(function(rg) { rg.points.rotation.y += rg.speed; });
            ...
            database_logic: function() {
                ...
                for (var i = 0; i < 30; i++) {
                    ...
                    var mat = new THREE.MeshBasicMaterial({
                        ...
                        transparent: true, opacity: 0.5, wireframe: Math.random() > 0.5
                    });
            ...
            feedback: function() {
                ...
                group.add(new THREE.Points(dotGeo, new THREE.PointsMaterial({
                    color: COL.signal, size: 0.4, transparent: true, opacity: 0.5, blending: THREE.AdditiveBlending
                })));
