...
requireMatch('.github/workflows/codeql.yml', /javascript-typescript/, 'CodeQL must analyze JavaScript/TypeScript');
requireMatch('.github/workflows/codeql.yml', /python/, 'CodeQL must analyze Python');
