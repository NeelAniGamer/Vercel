  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js"></script> <script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js">
  ...
  <script src="vehicles.js">
    ...
    function injectConflictModal(cloudS) {
        ...
        mo.innerHTML = '<div class="md" style="background:#111827; color:#E8E3D8; padding:20px; border-radius:12px; max-width:400px; margin:auto; margin-top:100px; z-index: 10001; position: relative;">' +
        ...
        if (!document.getElementById('col-ui-minimal')) {
            ...
            style.innerHTML = '.mo { position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 10000; display: none; }\n' +
...
switch (type) {
  ...
  <script defer src="../col-router.js">

  <script defer src="../col-ui.js">
